...
# Wrap up a source distribution of the book "Primes and Factorization".
...
#
# This results in a source tarball named "factorize-x.y.tar.bz2" and a
# PDF version of the book named "factorize-x.y.pdf". Thus, a version
